    ...
    public function renderPage(): void
    {
        ...
        <div class="wrap swift-admin">
            ...
            <p class="swift-admin__intro">
                <?php esc_html_e('Swift adds a "Buy now" button so shoppers can go straight to checkout and skip the cart, for fewer clicks and more completed orders. Configure where it appears and how it behaves below; changes apply to your storefront as soon as you save.', 'swift'); ?>
            </p>
            ...
            <form method="post" action="options.php">
                ...
                <div class="swift-card">
                    ...
                    <table class="form-table" role="presentation">
                        <tbody>
                            <?php
                            $this->checkboxRow('show_on_single', __('Single product page', 'swift'), __('Show the button on single product pages.', 'swift'), $settings, __('The product detail page. This is the highest-intent spot, where the shopper is already looking at the item.', 'swift'));
