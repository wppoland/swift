...
final class Settings implements HasHooks
{
    ...
    public function actionLinks(array $links): array
    {
        ...
        $settingsLink = sprintf(
            '<a href="%s">%s</a>',
            esc_url($url),
            esc_html__('Settings', 'plogins-swift'),
        );
        ...
        <div class="wrap swift-admin">
            <h1>
                ...
                <?php if ($enabled) : ?>
                    <span class="swift-status swift-status--on">
                        ...
                        <?php esc_html_e('Live', 'plogins-swift'); ?>
                    </span>
                <?php else : ?>
                    <span class="swift-status swift-status--off">
                        <span class="swift-status__dot" aria-hidden="true"></span>
                        <?php esc_html_e('Off', 'plogins-swift'); ?>
                    </span>
                <?php endif; ?>
            </h1>
            ...
            <form method="post" action="options.php">
                ...
                <div class="swift-card">
                    <h2><?php esc_html_e('Basics', 'plogins-swift'); ?></h2>
                    <table class="form-table" role="presentation">
                        <tbody>
                            <tr>
                                <th scope="row">
                                    <?php esc_html_e('Enable Buy Now', 'plogins-swift'); ?>
                                    <?php $this->help('master-switch', __('The master switch. When off, Swift adds no button, scripts or styles to your storefront at all, a clean, zero-footprint disable.', 'plogins-swift')); ?>
                                </th>
                                <td>
                                    <label for="swift_enabled">
                                        ...
                                        />
                                        <?php esc_html_e('Show the Buy Now button on your store.', 'plogins-swift'); ?>
                                    </label>
                                </td>
                            </tr>
                            <tr>
                                <th scope="row">
                                    <label for="swift_button_text"><?php esc_html_e('Button label', 'plogins-swift'); ?></label>
                                    <?php $this->help('button-label', __('The wording on the button. Short, action-led labels convert best, try "Buy now", "Get it now" or "Express checkout".', 'plogins-swift')); ?>
                                </th>
                                <td>
                                    <input
                                        type="text"
                    ...
                    <div class="swift-preview" aria-hidden="true">
                        <span class="swift-preview__label"><?php esc_html_e('Live preview:', 'plogins-swift'); ?></span>
                        <span class="swift-preview__btn swift-preview__btn--<?php echo esc_attr($style); ?>"><?php echo esc_html($label); ?></span>
                    </div>
                </div>

                <div class="swift-card">
                    <h2><?php esc_html_e('Placement', 'plogins-swift'); ?></h2>
                    <p class="swift-card__hint"><?php esc_html_e('Choose where the button shows up across your store.', 'plogins-swift'); ?></p>
                    <table class="form-table" role="presentation">
                        <tbody>
                            <?php
                            ...
                            <tr>
                                <th scope="row">
                                    <?php esc_html_e('Position on single product', 'plogins-swift'); ?>
                                    <?php $this->help('single-position', __('Whether Swift\'s button sits above or below WooCommerce\'s own "Add to cart" button on the product page.', 'plogins-swift')); ?>
                                </th>
                                <td>
                                    <fieldset>
                                        <legend class="screen-reader-text"><?php esc_html_e('Position on single product', 'plogins-swift'); ?></legend>
                                        <label for="swift_position_after">
                                            ...
                                            />
                                            <?php esc_html_e('After the add-to-cart button', 'plogins-swift'); ?>
                                        </label>
                                        <br />
                                        <label for="swift_position_before">
                                            ...
                                            />
                                            <?php esc_html_e('Before the add-to-cart button', 'plogins-swift'); ?>
                                        </label>
                                    </fieldset>
                                    <p class="description">
                                        <?php esc_html_e('Tip: you can also drop the button anywhere with the', 'plogins-swift'); ?>
                                        <code>[swift_buy_now]</code>
                                        <?php esc_html_e('shortcode, add id="123" to target a specific product.', 'plogins-swift'); ?>
                                    </p>
                                </td>
                            </tr>
                        </tbody>
                ...
                <div class="swift-card">
                    <h2><?php esc_html_e('Behaviour', 'plogins-swift'); ?></h2>
                    <p class="swift-card__hint"><?php esc_html_e('What happens when a shopper clicks Buy now.', 'plogins-swift'); ?></p>
                    <table class="form-table" role="presentation">
                        <tbody>
                            <tr>
                                <th scope="row">
                                    <?php esc_html_e('Redirect to', 'plogins-swift'); ?>
                                    <?php $this->help('redirect-target', __('Where the shopper lands after clicking. "Checkout" is the fast path that skips the cart entirely; "Cart" sends them to the cart page to review first.', 'plogins-swift')); ?>
                                </th>
                                <td>
                                    <fieldset>
                                        <legend class="screen-reader-text"><?php esc_html_e('Redirect to', 'plogins-swift'); ?></legend>
                                        <label for="swift_target_checkout">
                                            ...
                                            />
                                            <?php esc_html_e('Checkout (skip the cart)', 'plogins-swift'); ?>
                                        </label>
                                        <br />
                                        <label for="swift_target_cart">
                                            ...
                                            />
                                            <?php esc_html_e('Cart', 'plogins-swift'); ?>
                                        </label>
                                    </fieldset>
                                </td>
                            </tr>
                            <?php
                            $this->checkboxRow('clear_cart', __('Empty the cart first', 'plogins-swift'), __('Clear the cart before adding, so the buyer checks out with only the chosen product.', 'plogins-swift'), $settings, __('Recommended for a true "buy just this" flow. If a shopper already has items in their cart, this removes them so the Buy now purchase stands alone. Turn off to add to the existing cart instead.', 'plogins-swift'));
                            $this->checkboxRow('respect_quantity', __('Respect quantity', 'plogins-swift'), __('Carry the quantity chosen on the product page into the Buy Now purchase (single, simple products).', 'plogins-swift'), $settings, __('When on, the quantity the shopper picks in the product\'s quantity box is used for the Buy now purchase. When off, exactly one unit is bought. Single, simple products only.', 'plogins-swift'));
                            ?>
                        </tbody>
                    </table>
                </div>
                ...
                <div class="swift-card">
                    <h2><?php esc_html_e('Appearance', 'plogins-swift'); ?></h2>
                    <p class="swift-card__hint"><?php esc_html_e('How the button looks. Use the live preview above to check your choices.', 'plogins-swift'); ?></p>
                    <table class="form-table" role="presentation">
                        <tbody>
                            <tr>
                                <th scope="row">
                                    <?php esc_html_e('Button style', 'plogins-swift'); ?>
                                    <?php $this->help('button-style', __('"Theme default" inherits your theme\'s button look (safest, blends in). "Solid" and "Outline" use the accent colour below so the button stands out from the standard add-to-cart button.', 'plogins-swift')); ?>
                                </th>
                                <td>
                                    <fieldset>
                                        <legend class="screen-reader-text"><?php esc_html_e('Button style', 'plogins-swift'); ?></legend>
                                        <label for="swift_style_theme">
                                            ...
                                            />
                                            <?php esc_html_e('Theme default', 'plogins-swift'); ?>
                                        </label>
                                        <br />
                                        <label for="swift_style_solid">
                                            ...
                                            />
                                            <?php esc_html_e('Solid (accent colour)', 'plogins-swift'); ?>
                                        </label>
                                        <br />
                                        <label for="swift_style_outline">
                                            ...
                                            />
                                            <?php esc_html_e('Outline (accent colour)', 'plogins-swift'); ?>
                                        </label>
                                    </fieldset>
                                </td>
                            </tr>
                            <tr>
                                <th scope="row">
                                    <label for="swift_accent_color"><?php esc_html_e('Accent colour', 'plogins-swift'); ?></label>
                                    <?php $this->help('accent-colour', __('A hex colour used by the Solid and Outline styles. Leave empty to use Swift\'s velocity violet (#5b3df5). Pick a high-contrast brand colour so the button is easy to see and tap. Ignored by the "Theme default" style.', 'plogins-swift')); ?>
                                </th>
                                <td>
                                    <input
                                        type="text"
                                        ...
                                        placeholder="#5b3df5"
                                    />
                                    <p class="description"><?php esc_html_e('Hex colour for the Solid / Outline styles. Leave empty for Swift\'s velocity violet (#5b3df5).', 'plogins-swift'); ?></p>
                                </td>
                            </tr>
                        </tbody>
                    </table>
    ...
    private function help(string $key, string $text): void
    {
        ...
        <button
            ...
            aria-label="<?php esc_attr_e('Help', 'plogins-swift'); ?>"
        >?</button>
